...
export const routes: Routes = [
  ...
  { path: 'loja-poderes', component: LojaPoderesComponent },
  { path: 'loja-moedas', component: LojaMoedasComponent},
  { path: 'loja-skins', component: LojaSkinsComponent},
  { path: 'loja-diamantes', component: LojaDiamantesComponent},
  { path: 'loja-cenarios', component: LojaCenariosComponent},
